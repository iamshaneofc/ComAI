...
from app.api.v1 import agents, ai_config, analytics, auth, chat, debug, events, health, orders, platform, products, stores
...
protected.include_router(debug.router, prefix="/debug", tags=["Debug"])
